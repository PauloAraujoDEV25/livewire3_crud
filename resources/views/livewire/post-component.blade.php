                    ...
                    <h2 class="text-2xl font-bold mb-4">{{ $postId ? 'Edit Post' : 'Create Post' }}</h2>
                        <form wire:submit.prevent="{{ $postId ? 'update' : 'store' }}">
                            ...
                            <div class="mb-4">
                                ...
                                <textarea id="body" wire:model="body" rows="4" class="w-full border border-gray-300 px-4 py-2 rounded"></textarea>
                                <span class="text-red-500">@error('body') {{ $message }} @enderror</span>
                            </div>
                            <div class="flex justify-end">

                                <button type="submit" class="bg-green-500 hover:bg-green-600 text-white font-bold py-2 px-4 rounded mr-2">{{ $postId ? 'Update' : 'Create' }}
                                </button>
